...
const VENDOR_ORDER = ["CrowdStrike", "Microsoft", "Okta", "Proofpoint", "Jamf"];
const VENDOR_BADGE: Record<string, { initials: string; hue: number }> = {
  CrowdStrike: { initials: "CS", hue: 25 },
  Microsoft: { initials: "MS", hue: 230 },
  Okta: { initials: "OK", hue: 300 },
  Proofpoint: { initials: "PP", hue: 90 },
  Jamf: { initials: "JF", hue: 150 },
};

const SCENARIO_ENTRIES = Object.entries(VENDOR_SCENARIOS);
...
export default function SimulatorPage() {
  ...
  const scenariosForVendor = selectedVendor
    ? SCENARIO_ENTRIES.filter(([, s]) => s.vendor === selectedVendor)
    : SCENARIO_ENTRIES;

  const selected = scenarioKey ? VENDOR_SCENARIOS[scenarioKey] : null;
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 24, alignItems: "start" }}>
          ...
          <div style={SECTION_STYLE}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 10 }}>
              {VENDOR_ORDER.map((vendor) => {
                const badge = VENDOR_BADGE[vendor];
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16, position: "sticky", top: 24 }}>
          ...
          >
            <strong>Demo note:</strong> the vendor catalog above is static, curated data — nothing
